...
// 分页获取商品
const projectAll = '/api/v1/app/project/all';
// 商品详情
const projectDetail = '/api/v1/app/project/detail/';
// 商品付款
const projectPay = '/api/v1/app/project/pay';

// 代金券详情
const voucherDetail = '/api/v1/app/voucher/detail/';

// 获取支付方式和金额
const payChannel = '/api/v1/app/pay/channel';
// 拉起支付
const payPay = '/api/v1/app/pay/';

// 分页获取订单
const orderAll = '/api/v1/app/order/all';
// 获取订单详情
const orderDetail = '/api/v1/app/order/';
...
export {
	...
	// lyw----start
	projectAll,projectDetail,projectPay,voucherDetail,payChannel,payPay,orderAll,orderDetail
};
