...
// 获取验证码
const get_code = '/api/v1/app/user/get_code';

// 获取验证码
const register = '/api/v1/app/user/register';

// 获取验证码
const login = '/api/v1/app/user/login';

// 获取验证码
const forget_login_password = '/api/v1/app/user/forget_login_password';
