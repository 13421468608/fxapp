...
// 我的 个人信息
const  userInfoApi= '/api/v1/app/user/info'
// 我的 修改密码
const  userUpdatePwd= '/api/v1/app/user/update/login_password'
// 我的 修改个人信息
const  userUpdateInfo= '/api/v1/app/user/update/user_info'
// 我的 查看是否已实名
const  userRealnameCheck= '/api/v1/app/user/real_name/check'
// 我的 实名
const  userRealname= '/api/v1/app/user/real_name'


// 地址 获取所有地址
const  addressAll= '/api/v1/app/user/address/all'
// 地址 新增
const  addressCreate= '/api/v1/app/user/address/create'
// 地址 修改
const  addressUpd= '/api/v1/app/user/address/update/'
// 地址 删除
const  addressDel= '/api/v1/app/user/address/delete/'

// 银行卡 分页获取所有银行卡
const bankAll = '/api/v1/app/user/bank_card/all'
// 银行卡 创建
const bankCreate = '/api/v1/app/user/bank_card/create'
// 银行卡 删除
const bankDel = '/api/v1/app/user/bank_card/delete/'
...
export {
	...
	// lyw新增
	userInfoApi,userUpdatePwd,userUpdateInfo,userRealnameCheck,userRealname,
	addressAll,addressCreate,addressUpd,addressDel,
	bankAll,bankCreate,bankDel
};
